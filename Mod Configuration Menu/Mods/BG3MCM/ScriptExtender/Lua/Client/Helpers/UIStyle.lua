...
UIStyle.Colors = {
    ...
    ["NavCursor"] = Color.NormalizedRGBA(140, 0, 0, 0.78),
    ...
    ["TabDimmed"] = Color.NormalizedRGBA(13, 13, 13, 0.78),
    ["TabDimmedSelected"] = Color.NormalizedRGBA(13, 13, 13, 0.78),
